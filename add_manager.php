...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO managers (name, email, password, department, phone, created_by) VALUES (?, ?, ?, ?, ?, ?)");
            ...
            <div class="content">
                ...
                <div class="password-display-card">
                    <div class="password-card-header">
                        ...
                        <div>
                            <h3>Manager Login Credentials Created</h3>
                            <p>Share these credentials with the manager securely</p>
                        </div>
                    </div>
                    <div class="credentials-grid">
                        <div class="credential-box">
                            ...
                            <div class="credential-display">
                                <code id="username"><?php echo htmlspecialchars($_POST['email']); ?></code>
                                <button type="button" onclick="copyToClipboard('username')" class="btn-copy-credential">
                                    <svg viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div class="credential-box">
                            ...
                            <div class="credential-display">
                                <code id="password"><?php echo htmlspecialchars($generated_password); ?></code>
                                <button type="button" onclick="copyToClipboard('password')" class="btn-copy-credential">
                                    <svg viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z"/>
                                        <path d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z"/>
                                    </svg>
                    ...
                    <div class="password-warning">
                        ...
                        <span>Important: Save these credentials now. The password cannot be retrieved later.</span>
                    </div>
                    <div class="password-actions">
                        <a href="managers.php" class="btn-view-managers">View All Managers</a>
                        <a href="add_manager.php" class="btn-add-another">Add Another Manager</a>
                    </div>
                </div>
                <?php endif; ?>
                <?php endif; ?>
                    ...
                    <div class="form-header">
                        <div class="form-header-content">
                            ...
                            <div>
                                ...
                                <p>Create a new manager account with auto-generated credentials</p>
                            </div>
                        </div>
                    </div>
                    
                    <form method="POST" id="managerForm" class="manager-form">
                        <div class="form-section">
                            <div class="section-header">
                                <h3 class="section-title">Manager Information</h3>
                                <p class="section-description">Enter the manager's basic details</p>
                            </div>
                            ...
                            <div class="form-footer">
                                <div class="form-info">
                                    ...
                                    <span>A secure 8-character password will be automatically generated</span>
                                </div>
                                <div class="form-actions">
                                    <a href="managers.php" class="btn-secondary">
                                        <svg viewBox="0 0 20 20" fill="currentColor">
    ...
    <script>
        function copyToClipboard(elementId) {
            ...
            navigator.clipboard.writeText(text).then(() => {
                const button = element.parentElement.querySelector('.btn-copy-credential');
