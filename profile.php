 ...
 * Displays user information based on their role (Admin, Manager, Employee)
 */
...
<head>
    ...
    <style>
        ...
        .profile-info h2 { margin: 0 0 4px 0; color: #1f2937; }
        .profile-info p { margin: 0; color: #6b7280; font-size: 14px; }
        .info-grid {
            display: grid;
