...
// Get pending regularization requests count
$reg_count = $conn->query("SELECT COUNT(*) as count FROM attendance_regularization WHERE status = 'pending'")->fetch_assoc()['count'];

// Get pending OT requests count
$ot_count = $conn->query("SELECT COUNT(*) as count FROM overtime_requests WHERE status = 'pending'")->fetch_assoc()['count'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="#" class="nav-item">
                    ...
                    <span class="nav-text">OT Approvals</span>
                </a>
                <a href="#" class="nav-item">
                    <svg class="nav-icon" viewBox="0 0 20 20" fill="currentColor">
